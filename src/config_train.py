...
config["img_dir"] = "../data/brats20/TrainingData2018"
config["label_dir"] = "../data/brats20/TrainingData2018"
config["test_dir"] = "../data/brats20/ValidationData2018" # or change 'ValidationData' --> 'TestData' when you predict for test data
...
config["data_file"] = "../modelbra2018/brats20_data.h5"
config["data_file_test"] = "../modelbra2018/brats20_data_test.h5"
config["model_file"] = "../modelbra2018/"

config["training_file"] = "../modelbra2018/training_ids.pkl"
config["validation_file"] = "../modelbra2018/validation_ids.pkl"
config["test_file"] = "../modelbra2018/test_ids.pkl"
