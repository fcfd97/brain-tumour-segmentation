# -*- coding: utf-8 -*-
"""
Created on Thu Feb 24 20:52:39 2022
...
def test( gpu_id ):
   ...
   #     print('\n')
       ...
       # nib.save(nib.Nifti1Image(data,affine), 'predict/pre3/'+'pred'+str(i)+'.nii')
        nib.save(nib.Nifti1Image(data, affine), 'predict/pre7/' + 'pred' + str(i) + '.nii')
      ...
      #  print(label_names[i])
        ...
        acc1 = accuracy(jia1,seg1)
        acc2 = accuracy(jia2, seg2)
        acc3 = accuracy(jia3, seg3)
        hd1 = hd(jia1,seg1)
        hd2 = hd(jia2, seg2)
        hd3 = hd(jia3, seg3)
        asd1 = asd(jia1,seg1)
     ...
     #   sum = sum + val1 + val2 + val3
        b = [[val1[0],val2[0],val3[0],acc1,acc2,acc3,hd1,hd2,hd3,asd1,asd2,asd3]]
        write_excel_xls_append('predict/pre7/1wu.xls', b)
        print(val1[0],val2[0],val3[0],acc1,acc2,acc3,hd1,hd2,hd3,asd1,asd2,asd3)
