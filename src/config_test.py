...
config["test_dir"] = "../data/brats20/ValidationData"
...
config["test_file"] = "../model/test_ids.pkl"
config["num_test_files"] = 49 # Change it to number of test files #125

config["data_file"] = "../model/brats2020_data.h5"
config["data_file_test"] = "../model/brats2020_data_test.h5"
config["model_file"] = "../model/isensee_2017_model.h5"
config["training_file"] = "../model/isensee_training_ids.pkl"
config["validation_file"] = "../model/isensee_validation_ids.pkl"
config["test_file"] = "../model/isensee_test_ids.pkl"
